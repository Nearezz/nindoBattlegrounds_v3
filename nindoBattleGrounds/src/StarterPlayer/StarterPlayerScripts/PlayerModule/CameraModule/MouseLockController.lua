--[[
	...
	2018 Camera Update - AllYourBlox old one 1072110799
--]]

--[[ Constants ]]--
local DEFAULT_MOUSE_LOCK_CURSOR = "http://www.roblox.com/asset/?id=6872579222"
...
function MouseLockController:GetMouseLockOffset()
	...
	if offsetValueObj and offsetValueObj:IsA("Vector3Value") then
		...
		offsetValueObj.Value = Vector3.new(0,0,0) -- Legacy Default Value
