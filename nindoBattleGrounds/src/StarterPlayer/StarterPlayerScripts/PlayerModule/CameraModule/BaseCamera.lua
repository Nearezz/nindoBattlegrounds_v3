...
function BaseCamera:UpdateMouseBehavior()
	...
	--		UserGameSettings.RotationType = Enum.RotationType.MovementRelative
			...
			if player.Character:FindFirstChild('Running') and not player.Character:FindFirstChild('Swing') and not player.Character:FindFirstChild('Blocking') and not player.Character:FindFirstChild('Land_Stun') then
				UserGameSettings.RotationType = Enum.RotationType.MovementRelative
			else
