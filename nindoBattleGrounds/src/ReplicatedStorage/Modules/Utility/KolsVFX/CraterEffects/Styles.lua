local IgnoreList = {workspace.World} -- CHANGE THIS TO IGNORE SPECIFIC INSTANCES
...
local Parent = workspace.World.Effects -- SET THE PARENT USING THIS

local rayPart = function(CFrameValue, Range, Properties)
...
return {
	['Crater'] = function(AnchorPoint, settings)
		...
		for i = 1, partCount do
			...
			local newSize = Vector3.new(Magnitude + .5, settings['Size'].Y, settings['Size'].Z)
